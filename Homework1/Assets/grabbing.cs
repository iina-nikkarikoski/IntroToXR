    ...
    void Update()
    {
        ...
        if (grabbing)
        {
            ...
            if (grabbedObject)
            {
                ...
                grabbedObject.position = deltaRotation * (grabbedObject.position - transform.position);
        ...
        //otherHand.prevPosition = otherHand.transform.position;
        //otherHand.prevRotation = otherHand.transform.rotation;
    }
